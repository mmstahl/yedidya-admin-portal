 ...
 *
 * Exposes a protected REST API endpoint that returns member data
 * for the member list pipeline. Added by Michael Stahl for automating
 * the upload of files to the website.
 *
 * ENDPOINT
